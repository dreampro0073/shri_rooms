...
class Entry extends Model
{
    ...
    public static function getAvailPodsAr(){
        return DB::table('pods')->where('status',0)->pluck('e_no')->toArray();
    }

    public static function getAvailSinCabinsAr(){
        return DB::table('single_cabins')->where('status',0)->pluck('e_no')->toArray();
    }

    public static function getAvailBedsAr(){
        return DB::table('double_beds')->where('status',0)->pluck('e_no')->toArray();
    }

    public static function getBookedPodsAr(){
        return DB::table('pods')->where('status',1)->pluck('e_no')->toArray();
    }

    public static function getBookedSinCabinsAr(){
        return DB::table('single_cabins')->where('status',1)->pluck('e_no')->toArray();
    }

    public static function getBookedBedsAr(){
        return DB::table('double_beds')->where('status',1)->pluck('e_no')->toArray();
    }
    ...
    public static function totalShiftData($type = 1,$input_date= "",$user_id=0){
        ...
        if(Auth::user()->priv == 1){
            ...
            if($user_id == 0){
                ...
                $total_shift_upi += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('pay_type',2)->sum("paid_amount");

                $total_shift_cash = Entry::where('type',$type)->where('date',$input_date)->where('deleted',0)->where('pay_type',1)->sum("paid_amount");
                $total_shift_cash += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('pay_type',1)->sum("paid_amount");
                ...
                $last_hour_upi_total += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('pay_type',2)->whereBetween('created_at', [date('Y-m-d H:00:00'), date("Y-m-d H:i:s")])->sum("paid_amount"); 
                ...
                $last_hour_cash_total += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('pay_type',1)->whereBetween('created_at', [date('Y-m-d H:00:00'), date("Y-m-d H:i:s")])->sum("paid_amount");
            }else{
                ...
                $total_shift_upi += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('added_by',$user_id)->where('pay_type',2)->sum("paid_amount");
                ...
                $total_shift_cash += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('added_by',$user_id)->where('pay_type',1)->sum("paid_amount");
                ...
                $last_hour_upi_total += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('added_by',$user_id)->where('pay_type',2)->whereBetween('created_at', [date('Y-m-d H:00:00'), date("Y-m-d H:i:s")])->sum("paid_amount"); 
                ...
                $last_hour_cash_total += DB::table('e_entries')->where('type',$type)->where('status',0)->where('date',$input_date)->where('added_by',$user_id)->where('pay_type',1)->whereBetween('created_at', [date('Y-m-d H:00:00'), date("Y-m-d H:i:s")])->sum("paid_amount");
            }
            ...
            $total_shift_upi += DB::table('e_entries')->where('type',$type)->where('status',0)->where('added_by',Auth::id())->where('date',$p_date)->where('pay_type',2)->sum("paid_amount");
            ...
            $total_shift_cash += DB::table('e_entries')->where('type',$type)->where('status',0)->where('added_by',Auth::id())->where('date',$p_date)->where('pay_type',1)->sum("paid_amount");
            ...
            $last_hour_upi_total += DB::table('e_entries')->where('type',$type)->where('status',0)->where('added_by',Auth::id())->where('date',$p_date)->where('pay_type',2)->whereBetween('created_at', [date('Y-m-d H:00:00'), date("Y-m-d H:i:s")])->sum("paid_amount"); 
            ...
            $last_hour_cash_total += DB::table('e_entries')->where('type',$type)->where('status',0)->where('added_by',Auth::id())->where('date',$p_date)->where('pay_type',1)->whereBetween('created_at', [date('Y-m-d H:00:00'), date("Y-m-d H:i:s")])->sum("paid_amount");
